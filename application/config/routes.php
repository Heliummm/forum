...
$route['gallery'] = 'Main/gallery';      // Route untuk halaman galeri karya
$route['community'] = 'Main/community';  // Route untuk halaman komunitas
$route['gallery/upload'] = 'Main/upload_artwork';    // Route untuk unggah karya
